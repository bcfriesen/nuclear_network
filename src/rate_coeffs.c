 ...
 * temperature */
double
lambda_ijT (int i, int j, double T)
{
  double lambda_ij;
  if (i == 11 && j == 12)
    {
...
double
lambda_ijT_avg (int i, int j, double T, char product)
{
  double lambda_ij;
...
lambda_N15_P_A_C12 (double T)
{
  ...
  double fudge = 0.5;
  double lambda =
    1.08e+12 / T923 * exp (-15.251 / T913 - pow (T9 / 0.522, 2.0)) * (1.0 +
                                                                      0.027 *
                                                                      T913 +
                                                                      2.62 *
                                                                      T923 +
                                                                      ...
                                                                      2.60 *
                                                                      T953) +
    1.19e+08 / T932 * exp (-3.676 / T9) +
    5.41e+08 / T912 * exp (-8.926 / T9) +
    fudge * 4.72e+08 / T932 * exp (-7.721 / T9) +
    2.20e+09 / T932 * exp (-11.418 / T9);
  return lambda;
}

// lambda_{9, 12, alpha}
double
lambda_O17_P_A_N14 (double T)
{
  double T9 = T / 1.0e+09;
  ...
  double T923 = pow (T9, 2.0 / 3.0), T913 = pow (T9, 1.0 / 3.0),
    T943 = pow (T9, 4.0 / 3.0), T953 = pow (T9, 5.0 / 3.0),
    T932 = pow (T9, 3.0 / 2.0);
  double lambda = 1.53e+07 / T923 * exp (-16.712 / T913 - pow (T9 / 0.565,
                                                               2.0)) * (1.0 +
                                                                        0.025
                                                                        *
                                                                        T913 +
                                                                        ...
                                                                        * T9 +
                                                                        ...
                                                                        5.98 *
                                                                        T953)
    + fudge * (4.81e+10 * T9 * exp (-16.712 / T913 - pow (T9 / 0.040, 2.0)) +
               5.05e-05 / T932 * exp (-0.723 / T9)) +
    fudge2 * 1.31e+01 / T932 * exp (-1.961 / T9);
  return lambda;
}

// lambda_{11, 12}
double
lambda_O18_P_A_N15 (double T)
{
  double T9 = T / 1.0e+09;
  double T923 = pow (T9, 2.0 / 3.0), T913 = pow (T9, 1.0 / 3.0),
    T943 = pow (T9, 4.0 / 3.0), T953 = pow (T9, 5.0 / 3.0),
    T932 = pow (T9, 3.0 / 2.0);
  double lambda =
    3.63e+11 / T923 * exp (-16.729 / T913 - pow (T9 / 1.361, 2.0)) * (1.0 +
                                                                      0.025 *
                                                                      T913 +
                                                                      1.88 *
                                                                      T923 +
                                                                      ...
                                                                      2.06 *
                                                                      T953) +
    9.90e-14 / T932 * exp (-0.231 / T9) +
    2.66e+04 / T932 * exp (-1.670 / T9) +
...
lambda_C12_P_G_N13 (double T)
{
  ...
  double T923 = pow (T9, 2.0 / 3.0), T913 = pow (T9, 1.0 / 3.0),
    ...
    T932 = pow (T9, 3.0 / 2.0);
  double lambda =
    2.04e+07 / T923 * exp (-13.690 / T913 - pow (T9 / 1.500, 2.0)) * (1.0 +
                                                                      0.030 *
                                                                      T913 +
                                                                      1.19 *
                                                                      T923 +
                                                                      ...
                                                                      1.12 *
                                                                      T953) +
    1.08e+05 / T932 * exp (-4.925 / T9) +
    2.15e+05 / T932 * exp (-18.179 / T9);
  return lambda;
}

// lambda_{3, 12}
double
lambda_C13_P_G_N14 (double T)
{
  double T9 = T / 1.0e+09;
  double T923 = pow (T9, 2.0 / 3.0), T913 = pow (T9, 1.0 / 3.0),
    T943 = pow (T9, 4.0 / 3.0), T953 = pow (T9, 5.0 / 3.0),
  ...
  double lambda =
    8.01e+07 / T923 * exp (-13.717 / T913 - pow (T9 / 2.000, 2.0)) * (1.0 +
                                                                      0.030 *
                                                                      T913 +
                                                                      0.958 *
                                                                      T923 +
...
lambda_N14_P_G_O15 (double T)
{
  ...
  double T923 = pow (T9, 2.0 / 3.0), T913 = pow (T9, 1.0 / 3.0),
    ...
    T932 = pow (T9, 3.0 / 2.0), T965 = pow (T9, 6.0 / 5.0);
  double lambda =
    4.90e+07 / T923 * exp (-15.202 / T913 - pow (T9 / 1.191, 2.0)) * (1.0 +
                                                                      0.027 *
                                                                      T913 -
                                                                      0.778 *
                                                                      T923 -
...
// lambda_{6, 12, gamma}
double
lambda_N15_P_G_O16 (double T)
{
  double T9 = T / 1.0e+09;
  double T923 = pow (T9, 2.0 / 3.0), T913 = pow (T9, 1.0 / 3.0),
    T943 = pow (T9, 4.0 / 3.0), T953 = pow (T9, 5.0 / 3.0),
    T932 = pow (T9, 3.0 / 2.0), T965 = pow (T9, 6.0 / 5.0);
  double lambda = 9.78e+08 / pow (T9,
                                  2.0 / 3.0) * exp ((-15.251 /
                                                     pow (T9,
                                                          1.0 / 3.0)) -
                                                    pow (T9 / 0.450,
                                                         2.0)) * (1.0 +
                                                                  ...
                                                                  pow (T9,
                                                                       5.0 /
                                                                       3.0)) +
    1.11e+04 / pow (T9, 3.0 / 2.0) * exp (-3.328 / T9) + 1.49e+04 / pow (T9,
                                                                         3.0 /
                                                                         2.0)
    * exp (-4.665 / T9) + 3.80e+06 / pow (T9, 3.0 / 2.0) * exp (-11.048 / T9);
  return lambda;
}

// lambda_{7, 12}
double
lambda_O16_P_G_F17 (double T)
{
  double T9 = T / 1.0e+09;
  double T923 = pow (T9, 2.0 / 3.0), T913 = pow (T9, 1.0 / 3.0),
    T943 = pow (T9, 4.0 / 3.0), T953 = pow (T9, 5.0 / 3.0),
    T932 = pow (T9, 3.0 / 2.0), T965 = pow (T9, 6.0 / 5.0);
  double lambda =
    1.50e+08 / (T923 * (1.0 + 2.13 * (1.0 - exp (-0.728 * T923)))) *
    exp (-16.692 / T913);
  return lambda;
}
...
lambda_O17_P_G_F18 (double T)
{
  ...
  double lambda = 7.97e+07 * T9A56 / T932 * exp (-16.712 / T9A13)
    + 1.51e+08 / T923 * exp (-16.712 / T913) * (1.0 + 0.025 * T913 -
                                                0.051 * T923 -
                                                8.82e-03 * T9) +
    1.56e+05 / T9 * exp (-6.272 / T9) +
    fudge * 1.31e+01 / T932 * exp (-1.961 / T9);
  return lambda;
}
